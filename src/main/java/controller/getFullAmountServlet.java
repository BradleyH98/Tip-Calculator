...
/**
 * Servlet implementation class getFullAmountServlet
 */
@WebServlet("/getFullAmountServlet")
public class getFullAmountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getFullAmountServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("userTotal", tp);
		getServletContext().getRequestDispatcher("/resultAfterTax.jsp").forward(request, response);
